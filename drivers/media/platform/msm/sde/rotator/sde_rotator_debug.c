...
#if defined(CONFIG_LGE_DISPLAY_XLOG_ENABLED)
#define SDE_EVTLOG_DEFAULT_REGDUMP SDE_ROT_DBG_DUMP_IN_LOG | SDE_ROT_DBG_DUMP_IN_MEM
#define SDE_EVTLOG_DEFAULT_VBIF_DBGBUSDUMP SDE_ROT_DBG_DUMP_IN_LOG | SDE_ROT_DBG_DUMP_IN_MEM
#else
