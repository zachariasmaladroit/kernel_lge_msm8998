...
#ifdef CONFIG_OF
static int bootlog_parse_dt(struct bootlog_platform_data *pdata)
{
	struct device_node *node = of_find_compatible_node(NULL, NULL, "ramoops");
