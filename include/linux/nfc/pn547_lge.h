 ...
 */
#define pn547_SET_PWR   _IOW(PN547_MAGIC, 0x01, uint32_t)

#define pn547_HW_REVISION _IOR(PN547_MAGIC, 0x02, uint32_t)

#ifdef CONFIG_LGE_NFC_USE_PMIC
#define pn547_CLKS_SET _IOW(PN547_MAGIC, 0x03, uint32_t)
#endif
